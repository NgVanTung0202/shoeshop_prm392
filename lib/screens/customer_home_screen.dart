    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            Text("Chào mừng bạn,", style: TextStyle(color: Colors.grey, fontSize: 13)),
            Text(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(catName, style: TextStyle(color: isSelected ? Colors.white : Colors.blue.shade700)),
                ),
              );
            },
          );
        ...
        builder: (context, snapshot) {
          ...
          return GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: 2, childAspectRatio: 0.72, mainAxisSpacing: 18, crossAxisSpacing: 18,
            ),
